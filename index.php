...
<?php foreach($banner as $row){ 
    ...
    <?php if(!empty($row["titulo"])){ ?>
        <div class="large-6 medium-6  <?php echo (empty($row["imagen2"]))?' large-offset-6  small-12':' small-6 ';?> columns texto gulim ">        
          <?php echo $row["titulo"]; ?>
...
<div class="callout callout-1 color-1 ptope"><div class="row text-center">
  <div class="large-10 large-centered ptop columns">
		<h1 class="gulim color-5 bold">Agroforestal Nieto, en chiclayo, piura, trujillo, lima y todo el Perú. </h1>
...
WHERE p.estado_idestado=1 and m.estado_idestado=1 and ca.estado_idestado=1 and s.estado_idestado=1 ORDER BY p.orden DESC limit 0,9 ";
...
<div class="callout callout-4 fondo text-center"><div class="row"><div class="large-10 large-centered columns">
  <h4 class="gulim bold rel blanco">Variedad de soluciones en máquinas, repuestos y accesorios STIHL. Pulverizadoras JACTO.</h4>
</div></div></div>


 <div class="callout callout-5"><div class="row">
  <div class="large-text-center columns" >
  <h3 class="gulim bold color-1">Temas de interés <a href="blog">(ver más)</a></h3>
  </div>
        ...
        <a href="<?php echo $url; ?>">
          ...
          <div class="fii">
            <div class="float-left">
              <h2 class="gulim"><?php echo short_name($row['titulo'],70); ?></h2>
...
<div class="callout callout-3 fondo text-center">
  ...
  <h3 class="gulim bold rel blanco">ESTAMOS AQUÍ PARA USTEDES</h3>
</div></div></div>
