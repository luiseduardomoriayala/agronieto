...
<div class="ocultarwsp">
  <a style="position: absolute;bottom:0;z-index:999;width:50%;letter-spacing:1px;font-size:15px;text-align:center;background:#49CD60;padding:10px;margin:6px 0 0;color:white;" href="https://api.whatsapp.com/send?phone=51945360531&text=<?php echo $texto_cambiado;?>" target="_blank"><strong>WHATSAPP</strong></a>
  <a style="position:absolute;bottom:0;left:50%;z-index:999;letter-spacing:1px;font-size:15px;text-align:center;width:50%;background:#1ea7dd;padding:10px;color:white;margin:6px 0 0;" href="tel:+51945360531"><strong>LLAMAR</strong></a>
</div>
...
<footer class="salsa">
    ...
    <div class="mi-altura large-3 medium-3 columns p-top">      
      ...
      <p class="osans dire">Envios a todo el Perú. </br>Estamos en Chiclayo</p>
		...
		<div class="mi-altura large-3 medium-3 columns p-top">
      <p>Contáctanos:</br></p>
      <p class="bold"><img src="img/iconos/cel_movi.png" style="padding-right:7px;">+51945360531</p>      
      <p class="bold"><img src="img/iconos/was.png" style="padding-right:7px;">+51945360531</p>      
      <p><a href="mailto:ventas@naynut.com" target="_blank"><span class="color-2 bold">ventas@naynut.com</span></a></p>
		</div>
      ...
      <li><a href="https://www.facebook.com/Fruta-Deshidratada-Naynut-617127055308063/" target="_blank"><img src="img/iconos/fb.png"></a></li>
<!--         
...
-->
    ...
    <div class="large-12 medium-12 columns">
      <span class="float-left" style=""> © 2018 Naynut. Todos los derechos reservados.</span>
