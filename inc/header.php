...
<title><?php echo (isset($meta)?$meta['title']:'Naynut - Naturalmente Nutritivo');?></title>
<meta property="og:site_name" content="Naynut - Naturalmente Nutritivo"/>
<meta property="og:locale" content="es_ES"/>
<meta property="og:type" content="website"/>
<meta name="twitter:card" content="summary_large_image"/>
<meta name="twitter:title" content="Naynut - Naturalmente Nutritivo"/>
...
<?php } ?>  
  <nav> 
    <ul class="no-bullet amatic bold fullwidth">
<?php if(empty($_SESSION["suscritos"]["id_suscrito"])){ ?>
     <li>
...
<?php }//sesion
$menu=array(''=>'INICIO','productos'=>'PRODUCTOS','nosotros'=>'NOSOTROS','blog'=>'BLOG','contacto'=>'CONTÁCTENOS');
      foreach($menu as $k => $v){ $active = ($k== $pagina)? 'active-menu': '' ;    
?>          
      <li class="<?php echo $active;?>"><a href="<?php echo $k; ?>"><?php echo $v; ?></a></li>
<?php }    ?>    
    </ul>
 <?php if(!empty($_SESSION["suscritos"]["id_suscrito"])){ ?>
...
<header><div class=" franja2 row"><div class="large-12 columns callout-buscar">
  <div class="float-left">
    <a href="<?php echo $url;?>" class="logo"><img src="img/iconos/logo.png" alt="Naynut - Naturalmente Nutritivo"/></a>
  </div>
...
<?php $menu=array(''=>'INICIO','productos'=>'PRODUCTOS','nosotros'=>'NOSOTROS','blog'=>'BLOG','contacto'=>'CONTÁCTENOS');
foreach($menu as $k => $v){
$active = ($k== $pagina)?'active-menu':''; ?>          
          <li class="<?php echo $active;?>"><a href="<?php echo $k; ?>"><?php echo $v; ?></a></li>
<?php } ?>    
